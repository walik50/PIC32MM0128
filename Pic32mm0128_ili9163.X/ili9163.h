...
#define RESET_ON 	PORTBbits.RB6 = 0; 
#define RESET_OFF 	PORTBbits.RB6 = 1; 	
#define SCE_ON		PORTBbits.RB5 = 0; 
#define SCE_OFF		PORTBbits.RB5 = 1; 
#define DC_ON		PORTBbits.RB7 = 0;
#define DC_OFF		PORTBbits.RB7 = 1; 

#define DisplayCLK   PORTBbits.RB9
#define DisplaySDI   PORTBbits.RB8 
